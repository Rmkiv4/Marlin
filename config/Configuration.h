...
#define STRING_CONFIG_H_AUTHOR "(Mike_G SKR_1.4_Turbo)" // Who made the changes.
...
#define XY_PROBE_FEEDRATE (500*20)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 35 }
